...
# 📥 Load JSON
JSON_PATH = Path(__file__).parent / "YB.json"
...
async def start(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Welcome please choose a genre:", reply_markup=InlineKeyboardMarkup(keyboard))
...
def main():
    ...
    if not TOKEN:
        TOKEN = "8752478750:AAGD00YE7PTc2FtM6AmpBj-I9nTdJKvvAiM"  # ← Replace temporarily if needed
