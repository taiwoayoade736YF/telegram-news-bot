...
def extract_and_save(url, output_file='output.txt', format='txt'):
    """
    Extract visible text nodes from a URL and save to file.
...
# ===== USAGE EXAMPLES =====
# Save as plain text
extract_and_save('https://gnews.io', 'output.txt', format='txt')

# Save as JSON (with structure)
extract_and_save('https://gnews.io', 'output.json', format='json')

# Save as CSV (for Excel)
extract_and_save('https://gnews.io', 'output.csv', format='csv')